#!/usr/bin/env bash
# Render No Place / Part I slides to 1080x1350 PNGs.
...
python3 build_carousel_part1.py
mkdir -p out
for i in 01 02 03 04 05 06; do
  "$HS" --disable-gpu --no-sandbox --hide-scrollbars --force-device-scale-factor=1 \
    --window-size=1080,1350 --screenshot="out/noplace-part1-$i.png" \
    "file://$PWD/slides_part1/slide-$i.html" >/dev/null 2>&1
